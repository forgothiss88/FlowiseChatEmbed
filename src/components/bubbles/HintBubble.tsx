...
export const HintBubble = (props: Props) => {
  return (
    <div class="twi-flex twi-justify-end twi-guest-container twi-py-1 twi-w-full">
      <button
        class="twi-flex twi-cursor-pointer twi-items-center twi-bg-transparent twi-p-2 twi-pr-3 twi-max-w-[80%] twi-rounded-2xl twi-rounded-tr-none twi-whitespace-pre-wrap twi-font-light twi-text-sm twi-text-left twi-border-dashed twi-border"
