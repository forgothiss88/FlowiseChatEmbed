...
export const Popup = (props: PopupProps) => {
  ...
  return (
    <Show when={isBotOpened()}>
      <div class="twi-relative" aria-labelledby="modal-title" role="dialog" aria-modal="true" style={{ 'z-index': 9999999999 }} onClick={closeBot}>
        <div class="twi-fixed twi-inset-0 twi-bg-black twi-bg-opacity-50 twi-transition-opacity twi-animate-fade-in" />
        <div class="twi-fixed twi-inset-0 twi-overflow-y-auto">
